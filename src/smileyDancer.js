var makeSmileyDancer = function(top, left, timeBetweenSteps) {
  ...
  this.$node = $('<img src="https://vignette1.wikia.nocookie.net/awesome-face/images/5/5f/Rnbw_awesome_face.gif/revision/latest/scale-to-width-down/480?cb=20130303012342" width="100" height="100" class="dancer">');
